...
const Header = () => {
  ...
  const handleCopyCA = () => {
    navigator.clipboard.writeText("0x14c1c72adf5459280f41820af70f76d7d0bc4444");
  ...
  return (
    <nav style={styles.header}>
      ...
      <div style={styles.buttons}>
        ...
        <button style={styles.button} onClick={() => window.open("https://pancakeswap.finance/swap?outputCurrency=0x14c1c72adf5459280f41820af70f76d7d0bc4444", "_blank")}>BUY NOW</button>
      ...
      {isMobile && menuOpen && (
        <>
          ...
          <div style={styles.mobileMenu}>
            ...
            <button style={styles.hamburgerButton} onClick={() => window.open("https://pancakeswap.finance/swap?outputCurrency=0x14c1c72adf5459280f41820af70f76d7d0bc4444", "_blank")}>BUY NOW</button>
          </div>
        </>
      )}
    </nav>
